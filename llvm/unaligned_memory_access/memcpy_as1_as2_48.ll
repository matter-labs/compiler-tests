...
entry:
  ...
  call void @llvm.memcpy.p1i256.p2i256.i256(i256 addrspace(1)* align 1 %addr.1, i256 addrspace(2)* align 1 inttoptr (i256 128 to i256 addrspace(2)*), i256 48, i1 false)
