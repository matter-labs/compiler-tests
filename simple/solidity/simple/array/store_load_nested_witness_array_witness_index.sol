...
contract Test {
    ...
    function element9() public pure returns(uint64) {
        ...
        return main(array, 2, 2);
    }

    function main(uint8[SIDE_SIZE][SIDE_SIZE] memory array, uint8 i, uint8 j) private pure returns(uint8) {
        return array[i][j];
    }
}
